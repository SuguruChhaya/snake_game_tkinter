...
class Snake():
    ...
    def movement(self):
            ...
            #*The case in which the head has turned, but the body hasn't kept up.
                ...
                for part in self.snake_body:
                    ...
                    #*The rest of the snake which doesn't turn yet
                        ...
                        if self.turns[0][1] == 'up':
                            Snake.my_canvas.move(part, 0, -25)
                        elif self.turns[0][1] == 'down':
                            Snake.my_canvas.move(part, 0, 25)
                        elif self.turns[0][1] == 'left':
                            Snake.my_canvas.move(part, -25, 0)
                        elif self.turns[0][1] == 'right':
                            Snake.my_canvas.move(part, 25,0)
        ...
        print(f"snake direction is {self.snake_direction}")
        print(f"last direction is {self.last_direction}")
    ...
    def add_length(self):
      ...
      #*As long as the rectange is in the list, I don't think I have to name it.
        self.snake_body.append(Snake.my_canvas.create_rectangle(self.add_length_x1,self.add_length_y1,self.add_length_x2, self.add_length_y2, fill='green'))
